#!/usr/bin/env python3
"""
generate_expocafechile.py
Busca dados do board monday.com 18420881401 (Expocafé Chile)
...
<title>Relatório de Avaliação – Expocafé Chile 2026 | BSCA</title>
...
<section class="hero">
  <div class="hero-inner">
    ...
    <h1>Relatório de Avaliação<br><span>Expocafé Chile 2026</span></h1>
    <p>Resultados consolidados das avaliações recebidas das empresas participantes da Expocafé Chile 2026.</p>
  </div>
</section>
...
<footer class="site-footer">
  ...
  <p>BSCA – Associação Brasileira de Cafés Especiais &nbsp;·&nbsp; Projeto Brazil. The Coffee Nation &nbsp;·&nbsp; Expocafé Chile 2026</p>
</footer>
...
def push_to_github(html_content):
    ...
    GH_REPO   = os.environ.get("GITHUB_REPOSITORY", "renanfreitas-sketch/expocafechile2026")
    ...
    payload = {
        "message": f"expocafechile: auto-update {now}",
...
if __name__ == "__main__":
    ...
    print("Fetching monday.com data (Expocafé Chile 2026)…")
    raw = fetch_items()
    ...
    if "--dry-run" in sys.argv:
        with open("expocafechile2026.html", "w", encoding="utf-8") as f:
            f.write(html)
        print("Saved to expocafechile2026.html (dry run)")
    else:
        push_to_github(html)
        print("Done.")
